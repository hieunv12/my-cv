...
>
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: 16 }}>
    <div style={{ display: 'flex', alignItems: 'center' }}>
      ...
      />
      {!collapsed && <Col style={{ marginLeft: 16, whiteSpace: 'nowrap' }}>
        <Text style={{ fontSize: 16, fontWeight: 'bold', color: "#2F54EB" }}>
          Vikashini
        </Text>
        <Text style={{ display: 'block', fontSize: 10, fontWeight: 600 }}>
          REACTJS DEVELOPER
        </Text>
      </Col>}
    </div>
